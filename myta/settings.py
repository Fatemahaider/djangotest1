"""
Django settings for myta project.
...
SECRET_KEY = 'django-insecure-n20^tp59%#7-hjo$_o+onu+xw=nj&sm&g%w-aa%mb^euq1yii9'
...
WSGI_APPLICATION = 'myta.wsgi.application'
